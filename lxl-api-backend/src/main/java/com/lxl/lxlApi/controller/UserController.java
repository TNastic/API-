...
import com.lxl.lxlApi.model.dto.user.*;
...
//        //图片
//        if (userAvatar != null){
//            userAvatar = basePath + userAvatar;
//        }
//        userVO.setUserAvatar(userAvatar);
    ...
    @PostMapping("/change/akSk")
    public BaseResponse<Boolean> changeUserAkAndSk(HttpServletRequest request){
        User user = userService.getLoginUser(request);
        return ResultUtils.success(userService.changeUserAkAndSk(user));
    }
